...
class UpdatePromotionPUT extends RestExample
{
    /**
     * UpdatePromotionPUT constructor.
    ...
    public function __construct(CasinoRestV2 $casino)
    {
        ...
        try {
            $query = [
                ...
                'priority' => 0,
                'status' => true,
                'activation_date' => '2019-07-05T15:52:55.425Z',
                'expiration_date' => '2019-07-05T15:52:55.425Z',
            ...
            $result = $casino->PromotionService->updatePromotionPUT(json_encode($query));
            dd($result);
