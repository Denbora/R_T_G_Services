...
class CreateBonusBalanceSingleAccountModPercentageOfNextDepositCouponPOST extends RestExample
{
    /**
     * CreateBonusBalanceSingleAccountModPercentageOfNextDepositCouponPOST constructor.
    ...
    public function __construct(CasinoRestV2 $casino)
    {
        ...
        try {
            ...
            $result = $casino
                ->CouponService
                ->createBonusBalanceSingleAccountModPercentageOfNextDepositCouponPOST(json_encode($query));
            dd($result);
