...
use Closure;
use denbora\R_T_G_Services\Httpful\Exception\ConnectionErrorException;
use Exception;
...
class Request
{
    ...
    public function attach($files): Request
    {
    ...
    public function buildUserAgent()
    {
        ...
        $user_agent = $user_agent . $curl['version'] ?? $user_agent . '?.?.?';
